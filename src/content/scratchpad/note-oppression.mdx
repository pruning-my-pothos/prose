...
import HackyFormatting from "../../components/unique/HackyFormatting.astro";

<IntroParagraph>Every major note-taking app on the market works one way: linearly, in text. [Notion](https://www.notion.so/), [Roam](https://roamresearch.com/), [Evernote](https://evernote.com/), [OneNote](https://www.onenote.com/), [Bear](https://bear.app/), [Obsidian](https://obsidian.md/). They are all centred around writing text documents that flow from left-to-right, then top-to-bottom; the way all text works in English. Even if they support other languages, you'd still write Arabic or Hebrew or Urdu linearly, just right-to-left.</IntroParagraph>
...
<RemoteImage
	framed
	src="https://res.cloudinary.com/dxj9qr5gj/image/upload/c_scale,f_auto,q_auto:good,w_1200/v1621509754/pruningmypothos.com/notes/linear-notes/linear-scrawl_shrink_juilyb.png"
	showalt
