...
import GatheringBook from "../../images/books/gathering.webp";
import GetTogetherBook from "../../images/books/get-together.webp";
...
<IntroParagraph>I have been inadvertenly gathering people and putting on community events for about fifteen years. I say “inadvertently” because I've never sat down and thought “I want to be a community organiser.” What happens is I have a craving for certain kinds of experiences.</IntroParagraph>
...
<BasicImage
	width="900"
	src="/images/posts/gathering-structures/airtable.webp"
	alt="The signup form for demos at the Future of Coding meetup"
	framed
	showalt
/>
<BasicImage
	width="1300"
	src="/images/posts/gathering-structures/airtable2.webp"
	alt="The Airtable the Future of Coding form submissions are sent to"
	framed
	showalt
/>
...
<GridColumns gridGap="1rem" maxWidth="800px" margin="-1rem auto 4rem">

<BasicImage
	src="/images/posts/gathering-structures/darkly1.webp"
	alt="The group coordinating reading choices in WhatsApp"
	framed
/>
<BasicImage
	src="/images/posts/gathering-structures/darkly2.webp"
	alt="The group coordinating reading choices in WhatsApp"
	framed
/>
...
<BasicImage
	width="800"
	src="/images/posts/gathering-structures/unconf1.webp"
	alt="A nice big whiteboard of post-its with topics and ideas to discuss"
	showalt
/>
...
<BasicImage
	width="800"
	src="/images/posts/gathering-structures/unconf2.webp"
	alt="Session ideas with dot votes on them"
	sourceTitle="Technical.ly"
	sourceUrl="https://technical.ly/professional-development/barcamp-philly-2023-unconference/"
	showalt
/>
...
<BasicImage
	width="800"
	src="/images/posts/gathering-structures/unconf3.webp"
	alt="A filled out unconference schedule with times and room names"
	sourceTitle="Swarthmorean"
	sourceUrl="https://www.swarthmoreanarchives.com/articles/content/2021-11-20/have-you-been-to-an-unconference"
	showalt
/>
...
<BasicImage
	width="800"
	src="/images/posts/gathering-structures/fishbowl.webp"
	sourceTitle="Skills Converged"
	sourceUrl="https://www.skillsconverged.com/blogs/free-training-materials/fishbowl-conversation-technique"
	showalt
	alt="The classic setup of a fishbowl discussion"
/>
...
<BasicImage
	width="1000"
	src="/images/posts/gathering-structures/park.webp"
	alt="The perfect meeting venue"
	showalt
/>
...
<BasicImage
	width="800"
	src="/images/posts/gathering-structures/crabfit.webp"
	alt="Filling in which time slots you're for on Crab Fit"
	framed
	showalt
/>
...
<BasicImage
	width="800"
	src="/images/posts/gathering-structures/doodle.webp"
	alt="Selecting potential meeting times on Doodle"
	framed
	showalt
/>
...
<ResourceBook
	...
	url="https://www.google.co.uk/books/edition/The_Art_of_Gathering/jyJJDwAAQBAJ?hl=en&gbpv=0"
	author="Priya Parker"
	image={GatheringBook}
>
	The best book I've read on this subject. Well written and practical. Parker is
	a professional facilitator and has a vast array of experiences bringing people
	together in structured formats. Lots of meaty advice.
</ResourceBook>

<ResourceBook
	title="Get Together"
	url="https://www.google.co.uk/books/edition/Get_Together/BRnBEAAAQBAJ?hl=en&gbpv=0"
	author="Bailey Richardson, Kevin Huynh, and Kai Elmer Sotto"
	image={GetTogetherBook}
>
	I'm less hype about this one. Lots of people recommend it, but I found it a
	bit lightweight and mostly full of anecdotes. Buy if you want inspiration I
	guess. Gets bonus points for having a pretty cover and nice typesetting.
</ResourceBook>
