...
<IntroParagraph>My calendar fails me in many ways, but the most egregious is its failure to support speculative events.</IntroParagraph>
...
<GridColumns alignItems="start" margin="0 auto 3rem">

<BasicImage src="/images/posts/speculative-events/chat1.webp" framed />
<BasicImage src="/images/posts/speculative-events/chat2.webp" framed />

</GridColumns>

<Subtext>
	My highly inefficient standard process for coordinating meetings
</Subtext>
...
<BasicImage
	src="/images/posts/speculative-events/cal-notifs.webp"
	width="1100px"
...
<BasicImage
	src="/images/posts/speculative-events/spec-event.webp"
	width="1200px"
	alt="A speculative calendar event marked with a dotted border, light opacity background, and question mark icon"
	framed
/>
...
<BasicImage
	src="/images/posts/speculative-events/spec-event.gif"
	width="1400px"
	margin="1rem auto"
	alt="Marking a new calendar event as 'unconfirmed' in Mac calendar"
	framed
/>
...
<GridColumns gridTemplateColumns="3fr 4fr" alignItems="start" maxWidth="1600px" margin="0 auto var(--space-xl)">

<BasicImage
	src="/images/posts/speculative-events/cron.webp"
	width="685"
	alt="Selecting avaliable blocks in Cron"
	showalt
	framed
/>

<BasicImage
	src="/images/posts/speculative-events/amie.webp"
	width="915"
	alt="Booking an avaliable slot time in Amie"
	showalt
	framed
/>
...
<GridColumns alignItems="start" maxWidth="1400px" margin="1rem auto 2rem">

<BasicImage
	src="/images/posts/speculative-events/maybe2.webp"
	alt="Maybe events on HEY calendar"
	framed
/>

<BasicImage
	src="/images/posts/speculative-events/maybe.webp"
	alt="Maybe events on HEY calendar"
	framed
/>
...
<Subtext>
	Screenshots from the calendar [announcement
	video](https://www.youtube.com/watch?v=SztU4232u_o)
</Subtext>
