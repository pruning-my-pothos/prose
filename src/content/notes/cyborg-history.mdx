...
<IntroParagraph>The idea of the **Cyborg** was born in <YearsAgo>1960</YearsAgo> in the thick of the US-Soviet Space Race, to two NASA consultants trying to solve the problem of keeping humans alive in the hostile conditions of outer space.</IntroParagraph>
...
Anthropologist [Donna Haraway](https://en.wikipedia.org/wiki/Donna_Haraway) is a pioneer of using the term _Cyborg_ as an imaginative toy in her <YearsAgo>1991</YearsAgo> essay [The Cyborg Manifesto](https://warwick.ac.uk/fac/arts/english/currentstudents/undergraduate/modules/fictionnownarrativemediaandtheoryinthe21stcentury/manifestly_haraway_----_a_cyborg_manifesto_science_technology_and_socialist-feminism_in_the_....pdf). In Haraway’s writing, the Cyborg becomes a way to explore our cultural assumptions around the dividing lines between "nature" and "culture".
