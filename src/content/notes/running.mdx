...
<IntroParagraph>When I tell people I've run almost every day for the last twelve years, they hear the wrong things in it.<Footnote idName={1}>Minus 2021 when I took a year off for health issues. I chilled out a lot more after that, and now only run 4-5 times a week.</Footnote> They seem to be impressed in a warped way. Some launch into a strange self-flagellating tirade about how they could never do that, but wish they could, and begin listing all their attempts and failures. Wrapped up in all of this is a subtle attempt to put me and other runners on a moral pedestal in this interaction.</IntroParagraph>
