...
<IntroParagraph>There's an established concept called **Silent Meetings**. Much like it sounds, it's a meeting where for the most part no one talks.</IntroParagraph>
