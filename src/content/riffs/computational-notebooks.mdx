...
This approach of interleaving documentation and source code is called [literate programming](https://en.wikipedia.org/wiki/Literate_programming) and was first proposed by [Donald Knuth](https://en.wikipedia.org/wiki/Donald_Knuth) in <YearsAgo>1984</YearsAgo>. He argued that _all_ code should be written in these linear, readable documents. See Chris Granger's [Eve project](https://witheve.com/) for a beautiful example of mixing prose and code.
