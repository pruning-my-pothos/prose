...
In the mid-1980s the world of computer interfaces cracked in two<Footnote  idName={1}>Specifically, in <YearsAgo>1984</YearsAgo> when Apple's Macintosh became the first GUI-based computer to gain market traction. Honourable mentions: [Xerox Star](https://en.wikipedia.org/wiki/Xerox_Star) and [Apple Lisa](https://en.wikipedia.org/wiki/Apple_Lisa)</Footnote>, leaving a gaping divide between two opposing paradigms.

<Spacer size="xs" />

<GridColumns maxWidth="1200px" gridGap="3rem">
...
If a regular user in <YearsAgo>1980</YearsAgo> wanted to write a small programme to automate part of their workflow, the tools to do so were ready at hand. They could chain together small, composable UNIX commands in the same environment they do everything else in.
...
<BasicImage alt="" src="/images/posts/programming-portals/inkbase1.gif" />

Or dynamically changing numerical values with touch and drag slider:

<BasicImage alt="" src="/images/posts/programming-portals/inkbase2.gif" />
